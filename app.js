    ...
    try {
      ...
      reg.addEventListener('updatefound', () => {
        ...
        newWorker.addEventListener('statechange', () => {
          // Nuevo SW instalado y listo — recargar para aplicar cambios
          if (newWorker.state === 'installed' && navigator.serviceWorker.controller) {
            console.log('[SW] Nueva versión disponible — recargando...');
            // Decir al nuevo SW que tome el control inmediatamente
      ...
      navigator.serviceWorker.addEventListener('controllerchange', () => {
        // Evitar bucle de recargas con un flag en sessionStorage
      ...
      // Limpiar el flag tras la recarga
